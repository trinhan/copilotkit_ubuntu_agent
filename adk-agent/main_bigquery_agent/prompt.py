...
1.  Use the big query tool to search for posts which are relevant to the user's question. Suggest the top 3 posts or articles which are relevant to the user's question. Perform the following formating:
